...
sonar-scanner.bat -D"sonar.projectKey=30DaysOfJavaScript" -D"sonar.sources=." -D"sonar.host.url=http://127.0.0.1:9000" -D"sonar.token=sqp_9ae5891b9fe88921fc8b927189693d96afb10e52"
@goto end
